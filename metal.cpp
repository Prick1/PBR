...
glm::vec3 Metal::getBSDF(Ray incidentRay, Ray outGoingRay, glm::vec3 normal){
    ...
    ONB onb;
    onb.setFromV(normal);
    glm::dvec3 w_i = glm::transpose(onb.getBasisMatrix()) * incidentRay.direction_;
    glm::dvec3 w_o = glm::transpose(onb.getBasisMatrix()) * outGoingRay.direction_;
